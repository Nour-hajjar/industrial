...
@section('content')
    <!-- Page Header -->
    <header class="masthead" style="background-image: url({{ asset('/image/contact-bg.jpg') }})">
            ...
            <div class="col-md-4">
              <div class="contact-icon text-center">
                <div class="single-icon">
                  ...
                  <p>
                    <span>{{ trans('app.mail') }} :{{$footer->mailbox}}<br>
                   {{ trans('app.email') }}: {{$footer->email}}</span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="contact-icon text-center">
                <div class="single-icon">
                  ...
                  <p>
                    <span>{{App::isLocale('ar') ? $footer->ar_location:$footer->en_location}}</span>
...
@endif
               ...
               <option value="Contribution to law making">{{trans('app.Contribution')}}</option>
               <option value="Submit an idea or suggestion">{{trans('app.idea')}}</option>
               <option value="Site Administration">{{trans('app.Site_Administration')}}</option>
               <option value="report about link that does not working">{{trans('app.report')}}</option>
               <option value="Mr Chairman of the Board">{{trans('app.Mr')}}</option>
               </select>
                <div class="validate"></div>
                  </div>
                  <div class=" form-group">
               <select class="form-group custom mt-3  " name="Country" id="Country" >
...
<option value="ZW">{{trans('app.Zimbabwe')}}</option>  
                 ...
                 <div class="control-group">
                    <div class="form-group floating-label-form-group controls">
                        <label>Message</label>
                        <textarea rows="3" name="message" class="form-control" placeholder="{{trans('app.mess')}}" id="message" required
                ...
                <div id="success"></div>
                <div class="form-group">
                    <button type="submit" class="btn btn-primary" id="sendMessageButton">{{trans('app.send')}}</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
