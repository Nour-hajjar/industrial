            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{trans('app.service') .': '. $loan->id }}
                       
            <a class="btn btn-sm btn-primary float-right col-sm-2" href="{{ route('loans.index') }}">{{trans('app.Back')}} </a>
                        
                    </div>
                    <div class="card-body">
                        {!! Form::open(['route' => ['loans.update', $loan->id], 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
<img  src="{{ route('getImage',$loan->thumbnail) }}" style="width:400px" />
      
    
                         <div class="form-group @if($errors->has('thumbnail')) has-error @endif">
                                {!! Form::label(trans('app.Thumbnail')) !!}
                                {!! Form::text('thumbnail', $loan->thumbnail, ['class' => 'form-control', 'placeholder' => 'Thumbnail']) !!}
                        ...
                        <div class="form-group @if($errors->has('en_title')) has-error @endif">
                            ...
                            {!! Form::text('en_title', $loan->en_title, ['class' => 'form-control', 'placeholder' => 'EN_Title']) !!}
                            ...
                            {!! Form::text('ar_title', $loan->ar_title, ['class' => 'form-control', 'placeholder' => 'AR_Title']) !!}
                        ...
                        <div class="form-group @if($errors->has('en_sub_title')) has-error @endif">
                            ...
                            {!! Form::text('en_sub_title', $loan->en_sub_title, ['class' => 'form-control', 'placeholder' => 'EN Sub Title']) !!}
                         ...
                         <div class="form-group @if($errors->has('ar_sub_title')) has-error @endif">
                            ...
                            {!! Form::text('ar_sub_title', $loan->ar_sub_title, ['class' => 'form-control', 'placeholder' => 'AR_Sub Title']) !!}
                        ...
                        <div class="form-group @if($errors->has('en_details')) has-error @endif">
                            ...
                            {!! Form::textarea('en_details', $loan->en_details, ['class' => 'form-control', 'placeholder' => 'EN_Details']) !!}
                        ...
                        <div class="form-group @if($errors->has('ar_details')) has-error @endif">
                            ...
                            {!! Form::textarea('ar_details', $loan->ar_details, ['class' => 'form-control', 'placeholder' => 'AR_Details']) !!}
