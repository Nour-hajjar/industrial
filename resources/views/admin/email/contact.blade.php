...
<head>
  ...
  <title>Industrial Bank Email</title>
  <style type="text/css">
...
<table align="center" cellpadding="0" cellspacing="0" width="100%" height="100%">
  <tr>
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        ...
        <td style="border-bottom: 3px solid #3bcdc3;" width="100%">
          <center>
            <table cellspacing="0" cellpadding="0" width="500" class="w320">
              <tr>
                <td valign="top" style="padding:10px 0; text-align:left; color:#3bcdc3;font-size:25px;" class="mobile-center ">
                 Indistrial Bank
                </td>
              </tr>
            </table>
      ...
      <tr>
          <td  bgcolor="#8b8284" valign="top" style=" background-color:#ebebeb; background-position: center;">
                ...
                <tr>
                  <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" height="303">
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                      <tr>
                        <td>
                          <h1 style="color: gray;">Website mail</h1><br>
                          <h2 style="color: gray;">Contact Info From Customers and Visitors</h2>
                          <br>
                        </td>
                      </tr>
                    </table>
                ...
                <td>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <br>
                        Contact Info From Customers and Visitors <a style="color: #2BB6AC;" href="http://industrialbank.gov.sy/contact">contact us</a> with any questions regarding this invoice.
                      <br>
                      <br>
                    Industrial Bank
                      <br>
