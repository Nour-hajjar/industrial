...
<div class="row">
    <div class="col-lg-12 margin-tb" style="margin-top: 5%">
        <div class="pull-left">
            <h2 style="text-align: center;">{{trans('app.page')}}</h2>
        </div>
...
<table class="table" style="width: 90%;margin:5%;margin-top: 2%">   
  <tbody class="thead-light">
    ...
    <tr>
      ...
      <td>{{ $page->en_sub_title }}</td>
    </tr>    
    <tr>
      <th scope="row">{{trans('app.AR_Sub_Title')}}</th>
      <td>{{ $page->ar_sub_title }}</td>
    </tr>
 <tr>
     ...
     <tr>
      ...
      <td>{!! $page->en_details !!}</td>
        ...
        <div class="col-sm-4">
            <a class="btn btn-primary col-sm-12" href="{{ route('pages.index') }}">{{trans('app.Back')}} </a>
        </div>
        <div class="col-sm-4"></div>
        </div>
@endsection