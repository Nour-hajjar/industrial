                    ...
                    <div class="card-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group @if($errors->has('en_title')) has-error @endif">
                                ...
                                {!! Form::text('en_title', $page->en_title, ['class' => 'form-control', 'placeholder' => 'EN_Title']) !!}
                                @if ($errors->has('en_title'))
                                   <span class="help-block " style="color:red;">{!! $errors->first('en_title') !!}</span>@endif
                            </div>
                                   <div class="form-group @if($errors->has('title')) has-error @endif">
                                {!! Form::label(trans('app.AR_Title')) !!}
                                {!! Form::text('ar_title', $page->ar_title, ['class' => 'form-control', 'placeholder' => 'AR_Title']) !!}
                            ...
                            <div class="form-group @if($errors->has('en_sub_title')) has-error @endif">
                                ...
                                {!! Form::text('en_sub_title', $page->en_sub_title, ['class' => 'form-control', 'placeholder' => 'EN_Sub Title']) !!}
                                ...
                                {!! Form::text('ar_sub_title', $page->ar_sub_title, ['class' => 'form-control', 'placeholder' => 'AR_Sub Title']) !!}
                            ...
                            <div class="form-group @if($errors->has('en_details')) has-error @endif">
                                ...
                                {!! Form::textarea('en_details', $page->en_details, ['class' => 'form-control', 'placeholder' => 'EN_Details']) !!}
                               ...
                               <span class="help-block " style="color:red;">{!! $errors->first('en_details') !!}</span>@endif
                                ...
                                {!! Form::textarea('ar_details', $page->ar_details, ['class' => 'form-control', 'placeholder' => 'AR_Details']) !!}
