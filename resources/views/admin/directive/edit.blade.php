        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => ['directives.update', $directive->id], 'method' => 'put']) !!}
                

                        <div class="form-group @if($errors->has('name')) has-error @endif">
                            {!! Form::label(trans('app.name')) !!}
                            {!! Form::text('name', $directive->name, ['class' => 'form-control', 'placeholder' => 'Name']) !!}
                            @if ($errors->has('name'))
                            ...
                            {!! Form::text('name_a', $directive->name_a, ['class' => 'form-control', 'placeholder' => 'name_a']) !!}
                            ...
                            {!! Form::text('location', $directive->location, ['class' => 'form-control', 'placeholder' => 'location']) !!}
                            ...
                            {!! Form::text('location_a', $directive->location_a, ['class' => 'form-control', 'placeholder' => 'location_a']) !!}
                   ...
                   <div class="form-group @if($errors->has('fax')) has-error @endif">
                            ...
                            {!! Form::text('fax', $directive->fax, ['class' => 'form-control', 'placeholder' => 'fax']) !!}
                            @if ($errors->has('fax'))
                               <span class="help-block " style="color:red;">{!! $errors->first('fax') !!}</span>@endif
                        </div>
                               <div class="form-group @if($errors->has('mobile')) has-error @endif">
                            {!! Form::label(trans('app.mobile')) !!}
                            {!! Form::text('mobile', $directive->mobile, ['class' => 'form-control', 'placeholder' => 'mobile']) !!}
                           ...
                           <div class="form-group @if($errors->has('manager')) has-error @endif">
                            ...
                            {!! Form::text('manager', $directive->manager, ['class' => 'form-control', 'placeholder' => 'manager']) !!}
                           ...
                           <div class="form-group @if($errors->has('manager_a')) has-error @endif">
                            ...
                            {!! Form::text('manager_a', $directive->manager_a, ['class' => 'form-control', 'placeholder' => 'manager_a']) !!}
