            ...
            <a class="btn btn-sm btn-primary float-right col-sm-2" href="{{ route('posts.index') }}">{{trans('app.Back')}} </a>
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => 'posts.store', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            {!! Form::label('Thumbnail', null, ['style' => 'display: block;']) !!}
                            {!! Form::file('thumbnail[]', ['multiple' => 'multiple']) !!}
                            @if ($errors->has('thumbnail'))<span class="help-block " style="color:red;">
								{!! $errors->first('thumbnail') !!}</span>@endif
                        </div>
