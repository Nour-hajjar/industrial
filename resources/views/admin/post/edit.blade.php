            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{trans('app.edit_news') .': '. $post->id }}
                       
            <a class="btn btn-sm btn-primary float-right col-sm-2" href="{{ route('posts.index') }}">{{trans('app.Back')}} </a>
                        
                    </div>
                    <div class="card-body">
                        {!! Form::open(['route' => ['posts.update', $post->id], 'method' => 'put']) !!}
						<img  src="{{ route('getImage',$post->thumbnail) }}" style="width:400px" />
                        ...
                        <div class="form-group @if($errors->has('en_sub_title')) has-error @endif">
                            ...
                            {!! Form::text('en_sub_title', $post->en_sub_title, ['class' => 'form-control', 'placeholder' => 'EN Sub Title']) !!}
                         ...
                         <div class="form-group @if($errors->has('ar_sub_title')) has-error @endif">
                            ...
                            {!! Form::text('ar_sub_title', $post->ar_sub_title, ['class' => 'form-control', 'placeholder' => 'AR_Sub Title']) !!}
