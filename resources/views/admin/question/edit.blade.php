            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{trans('app.qes') .': '. $question->id }}
                       
            <a class="btn btn-sm btn-primary float-right col-sm-2" href="{{ route('questions.index') }}">{{trans('app.Back')}} </a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group @if($errors->has('en_title')) has-error @endif">
                            ...
                            {!! Form::text('en_title', $question->en_title, ['class' => 'form-control', 'placeholder' => 'EN_Title']) !!}
                            ...
                            {!! Form::text('ar_title', $question->ar_title, ['class' => 'form-control', 'placeholder' => 'AR_Title']) !!}
                        ...
                        <div class="form-group @if($errors->has('en_details')) has-error @endif">
                            ...
                            {!! Form::textarea('en_details', $question->en_details, ['class' => 'form-control', 'placeholder' => 'EN_Details']) !!}
                            ...
                            {!! Form::textarea('ar_details', $question->ar_details, ['class' => 'form-control', 'placeholder' => 'AR_Details']) !!}
